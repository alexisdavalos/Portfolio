...
const Nav = ({darkMode, setDarkMode}) => {
    ...
    return (
        <nav className={(darkMode === true) ? "navbar is-dark" : "navbar is-light"} role="navigation" aria-label="main navigation">
            ...
            {mobileNav ? 
                <div className={darkMode ? "navbar-menu is-active is-dark" : "navbar-menu is-active is-light"} id="navMenu">
                    <Link onClick={(e) => LoaderTimer(e) && setMobileNav(false)} to='/' className="navbar-item" ><span>Home</span></Link>
                    <Link onClick={(e) => LoaderTimer(e) && setMobileNav(false)} to='/about' className="navbar-item"><span>About</span></Link>
                    <Link onClick={(e) => LoaderTimer(e) && setMobileNav(false)} to='/projects' className="navbar-item"><span>Projects</span></Link>
                </div> : 
                <></>
            }
        </nav>
